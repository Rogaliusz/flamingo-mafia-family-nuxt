<template>
  <div id="fmf" class="fmf-container">
    <div>
      <img src="@/static/assets/boss.webp" width="400" class="img-card" />
    </div>
    <div class="fmf" style="max-width: 700px">
      <!-- Do You have lighter Don Flamingo? -->
      <h2 style="text-align: left">About</h2>

      <!-- Do You have weed Romeo? -->
      <h3 style="text-align: justify">
        The Flamingo Mafia Family is a collection of 10,101 unique NFT
        collectible Flamingos living on the ERC-721 Polygon blockchain. Each
        Flamingo was generated from over 140 different traits, including hats,
        hair, expressions, tattoos, clothes & more.
        <!-- No....  -->
        ...
        <ul class="social-media-ul">
          <li>
            <a class="discord social-link" href="https://discord.gg/k8JnYzgkpX">
              <svg width="40" height="40" version="1.1" viewBox="0 0 512 512">
          ...
          <li>
            <a class="social-link" href="https://twitter.com/donflamingonft">
              <svg width="40" height="40" viewBox="4 4 60 60">
                <path
...
.social-link:hover svg > g > .medium {
  fill: $accent;
}
